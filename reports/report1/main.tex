...
The weaknesses above are still the research topics, which are not easy to solve by me.

I thought about a specific panorama stitching case - scanning document by moving camera.
This problem is different from the first mentioned weakness.

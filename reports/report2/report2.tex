...
This can significantly produce the correct prediction result, and therefore, the time cost will get reduced apparently.
The cascade structure is shown in Figure \ref{fig:cs}.

\begin{figure}[t]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{cascading}
    \end{center}
    \caption{The cascading structure of the whole algorithm process. Data are picked from the original paper Section 5.}
    \label{fig:hsf}
\end{figure}

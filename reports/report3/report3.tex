...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{pure.jpg}
    \end{center}
...
That sentance is ``a man and woman walk down a street''.
...
in ``1198194316_543cc7b945.jpg#2'', the training sentence is ``A man and woman standing in front of a refreshment stand''.
